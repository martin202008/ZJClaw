...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install zjclaw-ai[matrix]"
    ) from e
...
from zjclaw.config.paths import get_data_dir, get_media_dir
from zjclaw.config.schema import Base
from zjclaw.utils.helpers import safe_filename
