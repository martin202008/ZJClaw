...
from zjclaw.channels.base import BaseChannel
from zjclaw.config.paths import get_media_dir
from zjclaw.config.schema import Base
from zjclaw.security.network import validate_url_target
from zjclaw.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm zjclaw.\n\n"
